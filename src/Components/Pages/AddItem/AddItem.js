...
const AddItems = () => {
    ...
    return (
        <div>
            <h2 className='my-md-5 my-4'>Add New Inventory Item</h2>
            <div className='form-container mx-auto border border-secondary rounded-3 px-md-3 py-md-5 p-3 mt-5 text-start'>
